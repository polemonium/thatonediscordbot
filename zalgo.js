...
//#########################################################################################################################################
		...
		/* <![CDATA[ */
			...
			//---------------------------------------------------
      module.exports = {
			zalgo: async function zalgo_textarea(message)
			{
				...
				for(var i=0; i<txt.length; i++)
				{
					...
					for(var j=0; j<num_up; j++)
						risingtxt += rand_zalgo(zalgo_up);
					
					for(var j=0; j<num_mid; j++)
						risingtxt += rand_zalgo(zalgo_mid);
					
					for(var j=0; j<num_down; j++)
						risingtxt += rand_zalgo(zalgo_down);
				}
        return risingtxt;
